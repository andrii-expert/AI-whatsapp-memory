...
export const WhatsAppConfig = z.object({
  ...
  welcomeButtonUrl: z.string().default('https://dashboard.crackon.ai/calendars'),
...
export const getWhatsAppConfig = (): WhatsAppConfigType => {
  try {
    return WhatsAppConfig.parse({
      ...
      welcomeButtonUrl: process.env.WHATSAPP_WELCOME_BUTTON_URL || 'https://dashboard.crackon.ai/calendars',
