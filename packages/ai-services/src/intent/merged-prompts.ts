...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "    • Category: Analyze the reminder content and context to determine the most appropriate category from: General, Birthdays, Once off, Family & Home, Work and Business, Health and Wellness, Errands, Travel, Notes",
    "      - Analyze the title, context, and purpose of the reminder to determine the category",
    "      - Birthdays: For birthday-related reminders (e.g., \"Paul birthday\", \"John's birthday\")",
    "      - Work and Business: For work-related tasks, meetings, business activities",
    "      - Family & Home: For family events, home maintenance, household tasks",
    "      - Health and Wellness: For health appointments, medication, wellness activities",
    "      - Errands: For shopping, picking up items, running errands",
    "      - Travel: For trips, flights, travel-related reminders",
    ...
    "      - \"Paul birthday 4 october\" → Create a reminder: Paul birthday - schedule: 4 october - status: active - category: Birthdays",
    "",
    "  UPDATE OPERATIONS:",
