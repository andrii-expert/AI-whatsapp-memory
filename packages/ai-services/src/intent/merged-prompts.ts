...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "    • \"show me my list\" → LISTS (Title: shopping)",
    "    • \"add milk to list\" → LISTS (Title: shopping)",
    "    • \"what's on my list\" → LISTS (Title: shopping)",
    "    • \"show lists\" → LISTS (Title: shopping)",
    ...
    "    Title: shopping",
    '    • "show my list" → (list = list by default) List items: all - status: all',
    '    • "show lists" → (lists = lists by default) List items: all - status: all',
    '    • "what\'s on my list" → (list = list by default) List items: all - status: all',
    '    • "show my list" → List items: all - status: all',
    '    • "what\'s on my list" → List items: all - status: all',
    ...
    "    • If parent folder specified: List list folders: {parent_folder_route} (shows categories)",
