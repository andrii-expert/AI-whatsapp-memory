...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    '    • "delete 1,3" (after listing shopping list) → Delete a shopping item: 1,3',
    '    • "delete items 1 and 3" (after listing shopping list) → Delete a shopping item: 1,3',
    '    • "delete 5,6" (after listing shopping items) → Delete a shopping item: 5,6',
    ...
    "  Delete a shopping item: {item_name|numbers} - on folder: {folder_route}",
    "    • If user says numbers like 'delete 1,3' or 'delete items 1 and 3' after listing shopping items, use: Delete a shopping item: {numbers} (NO folder needed for number-based deletion)",
    "    • Examples: 'delete 1,3' → Delete a shopping item: 1,3, 'delete items 1 and 3' → Delete a shopping item: 1,3",
    "    • CRITICAL: When deleting by numbers, do NOT include folder - just use: Delete a shopping item: {numbers}",
  ...
  "      - \"Show files in Work folder\" → Title: document\nList files: Work",
    ...
    "     - If last list was shopping items → Use: Delete a shopping item: {numbers} (NO folder)",
    "     - If last list was tasks → Use: Delete a task: {numbers} - on folder: {folder}",
    "     - If last list was notes → Use: Delete a note: {numbers}",
    "   • Examples:",
    "     - Previous: 'List shopping items: all - status: all', User: 'delete 5,6' → Delete a shopping item: 5,6",
    "     - Previous: 'List tasks: all - status: all', User: 'delete 1,3' → Delete a task: 1,3 - on folder: General",
    "   • CRITICAL: For shopping items deleted by numbers, NEVER include folder! Just: Delete a shopping item: {numbers}",
    "",
