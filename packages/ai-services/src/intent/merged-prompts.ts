...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "    • Category: Auto-detect from title (Birthdays, General, Work and Business, Family & Home, Health and Wellness, Errands, Travel, Notes)",
    "      - If title contains \"birthday\" or \"birth\" → category: Birthdays",
    "      - If title contains \"work\", \"business\", \"meeting\", \"office\" → category: Work and Business",
    "      - If title contains \"family\", \"home\", \"house\" → category: Family & Home",
    "      - If title contains \"health\", \"wellness\", \"doctor\", \"medication\" → category: Health and Wellness",
    "      - If title contains \"errand\", \"pick up\", \"buy\", \"grocery\" → category: Errands",
    "      - If title contains \"travel\", \"trip\", \"flight\", \"hotel\" → category: Travel",
    "      - If title contains \"note\", \"remember\" → category: Notes",
    "      - Otherwise → category: General (default)",
    "    • Examples:",
    ...
    "      - \"Set reminder for john birthday on the 4th October\" → Create a reminder: John birthday - schedule: on the 4th October - status: active (auto-detects Birthdays category)",
    "      - \"Remind me about Sarah's birthday on October 15th\" → Create a reminder: Sarah's birthday - schedule: on October 15th - status: active (auto-detects Birthdays category)",
    "      - \"Paul birthday 4 october\" → Create a reminder: Paul birthday - schedule: 4 october - status: active (auto-detects Birthdays category)",
    "",
    "  UPDATE OPERATIONS:",
