...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "    • ⚠️ For quantities: \"10 times\" → use \"10 x\" (e.g. \"add milk 10 times\" → Create a list item: Milk 10 x)",
    "",
    ...
    "        Create a list item: Milk",
    "        Create a list item: Eggs",
    '    • "add milk 10 times" / "milk 5 times" → use "X x" not "X times"',
    "        Create a list item: Milk 10 x   (or Milk 5 x)",
    "",
