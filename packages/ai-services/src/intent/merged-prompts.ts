...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "",
    "After the title:",
    "  • For task/note/reminder/event/document: provide the action template for that type",
    ...
    "",
    "Priority order: shopping list > task > note > reminder > event > document",
    ...
    "TASK OPERATIONS:",
    "  Title: task",
    "  Create a shopping item: {item_name}  (for shopping/grocery items - NO folder needed)",
