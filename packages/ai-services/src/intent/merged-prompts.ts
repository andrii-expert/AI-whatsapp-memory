...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    '    • "show xmas shopping list" → List shopping items: xmas - status: all',
    '    • "show [folder name] shopping list" → List shopping items: [folder name] - status: all',
    '    • "[folder name] shopping list" → List shopping items: [folder name] - status: all',
    '    • CRITICAL: When user says "show [folder] shopping list" or "[folder] shopping list", extract [folder] as the folder name!',
    ...
    "    • CRITICAL: When user says phrases like 'show [folder] shopping list', '[folder] shopping list', or 'show [folder] folder', extract [folder] as the folder_route!",
    "    • Examples: 'show xmas shopping list' → List shopping items: xmas - status: all",
    "    • Examples: 'groceries shopping list' → List shopping items: groceries - status: all",
    "    • Examples: 'show my shopping list' (no folder name) → List shopping items: all - status: all",
