...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "  2. When user doesn't specify ANY type at all (e.g., 'add milk', 'show me items', 'what do I need'), DEFAULT to SHOPPING LIST!",
    "  3. Shopping lists are the DEFAULT when the intent is unclear or no specific type is mentioned.",
    "",
