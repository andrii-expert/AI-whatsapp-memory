...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "    → If the last exchange shows a creation (e.g., \"✅ New Reminder Created: Put the trash out-1\"),",
    "      → \"delete it\" refers to that reminder: Delete a reminder: Put the trash out-1",
    ...
    "    → ⚠️ CRITICAL: \"delete it\" or \"remove it\" after a creation message refers to the LAST created item",
