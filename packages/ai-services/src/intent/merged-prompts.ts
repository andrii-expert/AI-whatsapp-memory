...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "  • For list/friend/reminder/event: provide the action template for that type",
  ...
  "      - If the user clearly wants to change the reminder type (daily/weekly/monthly/yearly/once), always use one of the allowed \"schedule\" forms.",
    ...
    "    • \"show event\" (SINGULAR) → Show event details/overview → Use: Show event details: {event_number_or_name}",
    "    • \"show events\" (PLURAL) → List multiple events → Use: List events: {timeframe|specific_date|all} - calendar: {calendar_name}",
    "",
    ...
    "    • User says: \"show events\", \"list events\", \"show my events\", \"what events\", \"all events\", \"my events\"",
