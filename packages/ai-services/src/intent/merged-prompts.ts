...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "    • For 'today' requests: use 'today'",
    "    • For 'tomorrow' requests: use 'tomorrow'",
    "    • For 'this week' or 'next few days' or 'coming up': use 'this week'",
    "    • For 'this month' or 'rest of the month': use 'this month'",
    "    • For general schedule/calendar requests without specific timeframe: use 'all'",
    "    • If no timeframe specified: List events: all",
