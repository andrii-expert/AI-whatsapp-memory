...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "• Use conversation history to understand context and previous clarifications",
    ...
    "",
    "⚠️ CRITICAL: HANDLING EVENT CONFLICT CONFIRMATIONS",
    "═══════════════════════════════════════════════════════════════",
    "",
    ...
    "",
    "⚠️ CRITICAL: Do NOT treat overlap confirmations as UPDATE operations!",
    ...
    "  • Reminder phrases: \"remind me\", \"do not let me forget\", \"remember to\", \"ping me\", \"nudge me\"",
    "  • Action words: call, send, pay, submit, follow up, buy, collect, pick up, check, renew, confirm, email, invoice",
