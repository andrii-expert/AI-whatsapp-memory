...
export function buildMergedWhatsappPrompt(
  ...
  "      - If the user clearly wants to change the reminder type (daily/weekly/monthly/yearly/once), always use one of the allowed \"schedule\" forms.",
    ...
    "    • CRITICAL: When user says \"show all tomorrow reminders\" or \"show all today reminders\", the word \"all\" means \"all of tomorrow's/today's reminders\", NOT a status filter.",
    "      - \"show all tomorrow reminders\" → List reminders: tomorrow (NOT \"List reminders: all tomorrow\" or \"List reminders: all\")",
    "      - \"show all today reminders\" → List reminders: today (NOT \"List reminders: all today\" or \"List reminders: all\")",
    "      - The timeframe (today, tomorrow, etc.) is the PRIMARY filter - \"all\" is just emphasis, not a separate filter",
    "    • Format examples:",
