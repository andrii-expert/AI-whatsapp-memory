...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "     - Next week starts on the NEXT Sunday (if today is Sunday, next week starts next Sunday)",
    "     - Calculate: Find the next Sunday, then find the [day] in that week",
    "     - Example: Today is Saturday, 24 January → Next week starts Sunday, 25 January → Next week Tuesday is 27 January",
    "     - Example: Today is Wednesday, 22 January → Next week starts Sunday, 26 January → Next week Tuesday is 28 January",
    ...
    "   • \"next week Tuesday\" → Find Tuesday of next week (next Sunday + 2 days)",
    "     - If today is Saturday, 24 Jan → Next Sunday is 25 Jan → Next week Tuesday is 27 Jan",
    "     - If today is Wednesday, 22 Jan → Next Sunday is 26 Jan → Next week Tuesday is 28 Jan",
    ...
    `      → CRITICAL: For \"next week [day]\", calculate: find next Sunday, then find [day] in that week`,
    `    • Examples:`,
    ...
    `      - \"what is next week Tuesday\" → Title: Normal\nNext week Tuesday will be on [calculate: next Sunday + 2 days from today]`,
