...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "    • Categories are single words like: Dairy, Fruits, Vegetables, Meat, Beverages, Snacks, Cleaning, Bakery, Frozen, Pantry, etc.",
    ...
    '    • "add apples in fruits category" →',
    "        Create a shopping item: Apples - category: Fruits",
    '    • "add milk to groceries folder in dairy category" →',
    "        Create a shopping item: Milk - on folder: Groceries - category: Dairy",
