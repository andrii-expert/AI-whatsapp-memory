...
export function buildMergedWhatsappPrompt(
  ...
  "      - If the user clearly wants to change the reminder type (daily/weekly/monthly/yearly/once), always use one of the allowed \"schedule\" forms.",
    ...
    "    • ⚠️ CRITICAL: For \"tomorrow\" and \"next tomorrow\", you MUST convert to a specific date format",
    "      - Calculate tomorrow's date based on current date: current date + 1 day",
    "      - Format: \"{day}{st|nd|rd|th} {Month}\" (e.g., \"27th January\", \"28th January\")",
    "      - This ensures the system correctly filters reminders for that specific date",
    "      - Examples (assuming current date is 26th January 2026):",
    "        • \"show all tomorrow reminders\" → List reminders: 27th January",
    "        • \"show tomorrow reminders\" → List reminders: 27th January",
    "        • \"list reminders for tomorrow\" → List reminders: 27th January",
    "        • \"show all reminders tomorrow\" → List reminders: 27th January",
    "      - ⚠️ NEVER use \"tomorrow\" as the filter - always convert to the specific date format",
    ...
    "      - \"List reminders: 27th January\" (for reminders on a specific date - MUST use specific date format)",
    "      - \"List reminders: 2nd February\" (for reminders on a specific date - MUST use specific date format)",
    ...
    "      - \"What reminders do I have?\" → List reminders: all",
      ...
      "      - \"Show me reminders for tomorrow\" → List reminders: 27th January (MUST convert tomorrow to specific date)",
    ...
    "      - \"What reminders do I have tomorrow?\" → List reminders: 27th January (MUST convert tomorrow to specific date)",
