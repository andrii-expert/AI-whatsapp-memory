...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    '    • "delete 1,3" (after listing shopping list) → Delete a task: 1,3 - on folder: Shopping List',
    '    • "delete items 1 and 3" (after listing shopping list) → Delete a task: 1,3 - on folder: Shopping List',
