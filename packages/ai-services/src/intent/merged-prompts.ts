...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "  • Title: document",
    "  • Title: friend",
    "  • Title: dashboard (for dashboard access requests)",
    "  • Title: Normal",
    "",
    "After the title:",
    "  • For shopping/reminder/event/document/friend: provide the action template for that type",
    "  • For dashboard: respond with: Dashboard access requested",
    ...
    "",
    "Priority order: shopping list > reminder > event > document > friend",
    ...
    "",
    "DASHBOARD: User wants to access their dashboard/web interface",
    "  Keywords: dashboard, show me my dashboard, show my dashboard, my dashboard, open dashboard, view dashboard, go to dashboard, access dashboard, see dashboard, open my dashboard, view my dashboard, access my dashboard, see my dashboard",
    "  Actions: show, open, view, access, see, go to",
    "  Patterns: \"show me my dashboard\", \"show my dashboard\", \"my dashboard\", \"open dashboard\", \"view dashboard\", \"dashboard\", \"go to dashboard\", \"access dashboard\", \"see dashboard\"",
    "  ⚠️ CRITICAL: When user asks for dashboard access, use Title: dashboard",
    "  Examples:",
    "    • \"show me my dashboard\" → Title: dashboard\nDashboard access requested",
    "    • \"show my dashboard\" → Title: dashboard\nDashboard access requested",
    "    • \"my dashboard\" → Title: dashboard\nDashboard access requested",
    "    • \"open dashboard\" → Title: dashboard\nDashboard access requested",
    ...
    "",
    "NORMAL: General conversation, greetings, questions, or messages that don't relate to reminders, events, documents, shopping lists, or friends",
    ...
    "      - \"show all lists\" / \"show lists\" → Title: shopping\nList shopping list folders: all",
    ...
    "      - \"create a list called Meeting plan\" → Title: shopping\nCreate a shopping list folder: Meeting plan",
    ...
    "    Title: shopping",
    '    • ⚠️ CRITICAL: "show all lists" / "show lists" / "show list folders" / "show my lists" = List shopping list folders: all (folder NAMES like Groceries, Home List). NOT list items!',
    '    • "show my list" → (list = items in primary list) List shopping items: Home - status: all',
    '    • "what\'s on my list" → List shopping items: Home - status: all',
    ...
    '    • ⚠️ CRITICAL: "create a list called X" / "make a list called X" = Create a list folder: X. NEVER Create a file folder!',
    '    • "rename groceries to food" → Edit a list folder: Groceries - to: Food',
    '    • "Change Home List to primary" / "Change Homt List to primary" / "Make Groceries primary" → Set primary list: Home List (or Homt List, or Groceries)',
    ...
    '    • "show all lists" / "show lists" / "show list folders" / "show my lists" / "show my shopping list folders" → List shopping list folders: all',
    ...
    "    • If user asks for ITEMS across all lists (e.g. \"all items\", \"show all items\", \"everything from all lists\"): use folder_route = all. NOT for \"show all lists\" - that is folders!",
    ...
    "    • NEVER output \"already set as primary\" or \"Would you like to change it to a different list\" - ALWAYS output Set primary list: X. You cannot know which list is primary; the system executes and responds.",
    ...
    "      \"Make Groceries my primary list\" → Set primary list: Groceries",
    "      \"Set Paul as primary\" → Set primary list: Paul",
    ...
    "    • ⚠️ CRITICAL: \"show all lists\" / \"show lists\" / \"show list folders\" = folder NAMES (Groceries, Home List, etc). Use List shopping list folders: all. NEVER use List shopping items!",
  ...
  "      - If the user clearly wants to change the reminder type (daily/weekly/monthly/yearly/once), always use one of the allowed \"schedule\" forms.",
    ...
    "    • ⚠️ NEVER use Update when user says \"create\", \"add\", \"set up\", \"schedule\" - those are CREATE. Same title as existing event = still CREATE (new separate event).",
    ...
    "    • ⚠️ CRITICAL: \"show all items\" = list items. Use List items: all - status: all. NEVER List files!",
    ...
    "",
    "═══════════════════════════════════════════════════════════════",
    "STEP 4: SHARING RECOGNITION (for shopping lists, tasks, notes, and documents)",
    "═══════════════════════════════════════════════════════════════",
    "",
    ...
    "   • If user mentions anything that could be a reminder/event/document/shopping list/friend, treat it as CREATE unless explicitly stated otherwise",
    ...
    "     ⚠️ CRITICAL: \"Create a meeting called X\" / \"Add meeting named X\" = ALWAYS Create an event. NEVER Update - even if an event named X already exists. Same-name = separate new event.",
    ...
    "   • If the message is clearly NOT about reminders, events, documents, shopping lists, or friends, use Title: Normal",
    ...
    "",
    "⚠️ NEVER ASK FOR CLARIFICATION WHEN:",
    "   • \"Change X to primary\" / \"Make X primary\" / \"Set X as primary\" (lists) → ALWAYS use Set primary list: X. Do NOT ask \"rename or set as main?\"; it is ALWAYS set primary.",
    "",
    ...
    "",
    "  Title: Normal",
    "  Hello! How can I help you manage your reminders, events, documents, shopping lists, friends, or addresses today?",
    "",
    "═══════════════════════════════════════════════════════════════",
