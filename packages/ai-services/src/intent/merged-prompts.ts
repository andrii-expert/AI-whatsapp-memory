...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    '    • "make the Home List as primary" / "make X as primary" → Set primary list: Home List (use exact folder name, no "the" or "as primary")',
    ...
    "    • \"Change List1 to Primary\" / \"Change List1 to Primary list\" / \"Make Paul my primary list\" / \"Make the Home List as primary\" → Set primary list: List1 (or Paul, or Home List - use the exact list name from the user's message)",
