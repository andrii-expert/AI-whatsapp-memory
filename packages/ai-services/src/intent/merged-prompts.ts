...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "    • For today's reminders: List reminders: all (filtering happens in backend)",
    "    • Examples:",
    "      - \"Show my reminders\" → List reminders: all",
    "      - \"What reminders do I have?\" → List reminders: all",
    "      - \"Show today's reminders\" → List reminders: all",
    "      - \"What reminders are due today?\" → List reminders: all",
