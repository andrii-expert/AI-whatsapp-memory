...
export function buildMergedWhatsappPrompt(
  ...
  return [
    ...
    "═══════════════════════════════════════════════════════════════",
    "",
    "SHOPPING LIST (Special Task Type - Check FIRST!):",
    "  Shopping list is a SPECIAL type of task. When user mentions shopping or groceries,",
    "  ALWAYS use folder: Shopping List (not General).",
    "",
    ...
    "    • ALL shopping items go to folder: Shopping List",
    "    • Preserve item names (capitalize first letter)",
    "",
    "  SHOPPING LIST EXAMPLES (follow EXACTLY):",
    "    Title: task",
    ...
    "TASK OPERATIONS:",
    "  Title: task",
    "  Create a shopping item: {item_name} - on folder: Shopping List  (for shopping/grocery items)",
