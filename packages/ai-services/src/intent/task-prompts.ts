export interface TaskPromptOptions {
  ...
  export function buildWhatsappTaskPrompt(
    ...
    return [
      ...
      "  • When shopping context is detected, EACH item becomes a SEPARATE task",
      "  • Common shopping items: milk, bread, eggs, cheese, butter, vegetables, fruits, meat, chicken, fish,",
      "    rice, pasta, sugar, salt, oil, cleaning supplies, toilet paper, soap, shampoo, etc.",
      "  • Parse items separated by: commas, \"and\", line breaks, bullets, or natural pauses",
      "  • ALL shopping items go to folder: Shopping List (not General)",
      "  • Preserve item names as task titles (capitalize first letter)",
      "",
      "SHOPPING LIST EXAMPLES (follow these EXACTLY):",
      '  • "add milk to shopping list" → Create a shopping item: Milk - on folder: Shopping List',
      '  • "shopping list: milk, bread, eggs" →',
      "       Create a shopping item: Milk - on folder: Shopping List",
      "       Create a shopping item: Bread - on folder: Shopping List",
      "       Create a shopping item: Eggs - on folder: Shopping List",
      '  • "I need to buy milk and bread" →',
      "       Create a shopping item: Milk - on folder: Shopping List",
      "       Create a shopping item: Bread - on folder: Shopping List",
      '  • "add eggs, cheese, butter to groceries" →',
      "       Create a shopping item: Eggs - on folder: Shopping List",
      "       Create a shopping item: Cheese - on folder: Shopping List",
      "       Create a shopping item: Butter - on folder: Shopping List",
      '  • "groceries: apples, bananas, oranges" →',
      "       Create a shopping item: Apples - on folder: Shopping List",
      "       Create a shopping item: Bananas - on folder: Shopping List",
      "       Create a shopping item: Oranges - on folder: Shopping List",
      '  • "need to get toilet paper and soap" →',
      "       Create a shopping item: Toilet paper - on folder: Shopping List",
      "       Create a shopping item: Soap - on folder: Shopping List",
      '  • "buy 2 liters of milk, a loaf of bread" →',
      "       Create a shopping item: 2 liters of milk - on folder: Shopping List",
      "       Create a shopping item: A loaf of bread - on folder: Shopping List",
      '  • "pick up some veggies from the store" → Create a shopping item: Veggies - on folder: Shopping List',
      ...
      '  • "clear shopping list" → Delete all tasks in folder: Shopping List',
      ...
      "       Create a shopping item: {item_name} - on folder: Shopping List",
      "       • Use when: shopping list, groceries, things to buy, need to buy, have to buy",
      "       • Each item becomes a separate line",
      "",
