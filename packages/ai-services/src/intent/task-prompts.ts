export interface TaskPromptOptions {
  ...
  export function buildWhatsappTaskPrompt(
    ...
    return [
      ...
      "",
      "═══════════════════════════════════════════════════════════════",
      "STEP 2: CHECK FOR SHOPPING LIST (#1 PRIORITY - DO THIS FIRST!)",
      "═══════════════════════════════════════════════════════════════",
      "",
      "⚠️ SHOPPING LIST HAS THE HIGHEST PRIORITY! Check for shopping keywords BEFORE anything else! ⚠️",
      "",
      "Shopping list is a SPECIAL type of task list. When the user mentions anything related to shopping or groceries,",
      "this ALWAYS takes priority over regular task creation.",
      "",
      ...
      '  • "show groceries folder" → List tasks: Groceries - status: open',
      ...
      '  • "edit bread in groceries" → Edit a task: Bread - to: {new_name} - on folder: Groceries',
      "",
      ...
      "   • EXCEPTION: For shopping/grocery items, only include folder if user mentions it",
      ...
      "       Create a shopping item: {item_name}  (if no folder mentioned)",
      "       Create a shopping item: {item_name} - on folder: {folder_route}  (if folder mentioned)",
      ...
      "       • If user mentions a folder, include it in the format above",
      "",
